...
#include"core/shader.h"//包含头文件是一个拓扑结构，其他的不用都添加进来
//1
...
SceneInfo load_scene(int scene_index)
{
	...
	case 0:
		...
		ret.scene = new SingleModelScene("C:/Users/53190/Desktop/敏的光栅器/MinerSoftRender/assert/african_head/african_head.obj", frame_buffer);
		break;
	case 1:
		ret.name = "2.diablo3_pose";
		ret.scene = new SingleModelScene("C:/Users/53190/Desktop/敏的光栅器/MinerSoftRender/assert/diablo3_pose/diablo3_pose.obj", frame_buffer);
		break;
	default:
