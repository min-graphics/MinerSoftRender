...
{
	Matrix4 m_translation = translate(transform.position.x, transform.position.y, transform.position.z);
	Matrix4 m_rotate = rotate_z(TO_RADIANS(transform.rotation.z)) * rotate_x(TO_RADIANS(transform.rotation.x)) * rotate_y(TO_RADIANS(transform.rotation.y));
	Matrix4 m_scale = scale(transform.scale.x, transform.scale.y, transform.scale.z);
